...
export function useCall() {
    const { activeCall, startCall: storeStartCall, answerCall: storeAnswerCall, endCall: storeEndCall, setIncomingCall, setCallStatus, toggleMute: storeToggleMute, toggleVideo: storeToggleVideo, toggleScreenShare: storeToggleScreenShare, toggleSpeaker: storeToggleSpeaker, } = usePeerStore();
    const localVideoRef = useRef(null);
    const remoteVideoRef = useRef(null);
    // Start an outgoing call
    const startCall = useCallback(async (peerId, conversationId, type) => {
        try {
    ...
    useEffect(() => {
        ...
        const handleCallRequest = ({ fromPeerId, callType, callId, displayName }) => {
        ...
        const handleCallAccepted = ({ fromPeerId, callId }) => {
        ...
        const handleCallRejected = ({ fromPeerId, callId, reason }) => {
        ...
        const handleCallEnded = ({ fromPeerId, callId }) => {
