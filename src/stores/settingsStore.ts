...
export type Theme = 'dark' | 'light' | 'system' | 'midnight' | 'amoled';
export type Language = 'en' | 'tr' | 'de' | 'fr' | 'es' | 'pt' | 'ru' | 'zh' | 'ja' | 'ko';
...
export interface PrivacySettings {
  ...
  showReadReceipts: boolean;
  showTypingIndicators: boolean;
  allowProfilePhoto: 'everyone' | 'contacts' | 'nobody';
  allowStatusUpdates: 'everyone' | 'contacts' | 'nobody';
...
export interface ChatSettings {
  ...
  defaultDisappearingTimeout?: number; // seconds
  archiveOnMute: boolean;
...
interface SettingsState {
  ...
  updateMedia: (updates: Partial<MediaSettings>) => void;
  updateChat: (updates: Partial<ChatSettings>) => void;
  updateNetwork: (updates: Partial<NetworkSettings>) => void;
  updateStorage: (updates: Partial<StorageSettings>) => void;
  updateShortcuts: (updates: Partial<KeyboardShortcuts>) => void;
...
const defaultMedia: MediaSettings = {
